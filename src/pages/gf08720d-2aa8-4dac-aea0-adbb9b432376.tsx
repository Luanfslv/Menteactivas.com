...
export default function Q7(){
    ...
    <section className="bg-[#ebffff] fadeIn">
        <Tracking currentQuestionNumber={7} path={BUTTON_PATH} />
        <div className="px-[20px] pb-[45px]">
            <div className="flex justify-between items-center p-[20px] sm:p-[40px] pt-[30px] md:pt-[70px]">
                    ...
                    <h1 className="text-black md:text-[25px] text-[17px]"><span className="font-bold">7 </span> / 14</h1>
            </div>
            <ProgressBar>
                <div className="h-full bg-[#f2a516] rounded-[2px]" style={{width: "42%"}}></div>
            </ProgressBar>
            <div className="flex justify-center items-center flex-col">
                <div className="max-w-[108px] sm:max-w-[150px] md:max-w-[200px] lg:max-w-[250px]">
                    <img className="w-full" src="q7h.svg" alt="" />
                </div>
                <div className="mb-[20px]">
                    <h1 className="text-[#6700a7] font-bold text-[24px] max-w-[360px] md:max-w-[540px] text-center md:text-[42px]">¿Te sientes ansioso todos los días?</h1>
                ...
                <div className="flex flex-col items-center justify-center mt-[40px] gap-[22px] text-center px-8 w-full">
                    <ButtonLink href={BUTTON_PATH}><span className="max-w-[250px]">Sí, todos los días</span></ButtonLink>
                    <ButtonLink  href={BUTTON_PATH}><span className="max-w-[250px]">No, solo tengo crisis en días específicos</span></ButtonLink>
                    <BackButton to="/f4a73b2d-47cc-4e21-9893-d23f8d7dd09c"></BackButton>
                </div>
