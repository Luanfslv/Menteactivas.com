...
export default function Q4(){
    ...
    const BUTTON_PATH = "/e39b83ba-6dee-4abf-8f59-41fa2c500e46";
    useEffect(() => {
    ...
    <section className="bg-[#ebffff] fadeIn">
        <Tracking currentQuestionNumber={4} path={BUTTON_PATH} />
        <div className="px-[20px] pb-[45px]">
            <div className="flex justify-between items-center p-[20px] sm:p-[40px] pt-[30px] md:pt-[70px]">
                    ...
                    <h1 className="text-black md:text-[25px] text-[17px]"><span className="font-bold">4 </span> / 14</h1>
            </div>
            <ProgressBar>
                <div className="h-full bg-[#f2a516] rounded-[2px]" style={{width: "21%"}}></div>
            </ProgressBar>
            <div className="flex justify-center items-center flex-col">
                <div className="max-w-[108px] sm:max-w-[150px] md:max-w-[200px] lg:max-w-[250px]">
                    <img className="w-full" src="q4h.svg" alt="" />
                </div>
                <div className="mb-[20px]">
                    <h1 className="text-[#6700a7] font-bold text-[24px] max-w-[360px] md:max-w-[540px] text-center md:text-[42px]">¿Qué tan fácil te distraes?</h1>
                ...
                <div className="flex flex-col items-center justify-center mt-[40px] gap-[22px] text-center px-8 w-full">
                    <ButtonLink  href={BUTTON_PATH}>Fácilmente</ButtonLink>
                    <ButtonLink  href={BUTTON_PATH}>Algunas veces me distraigo</ButtonLink>
                    <ButtonLink  href={BUTTON_PATH}>Rara veces</ButtonLink>
                    <ButtonLink  href={BUTTON_PATH}>Siempre me concentro</ButtonLink>
                    <BackButton to="/cac3de14-3009-45b0-b070-592891610bc5"></BackButton>
                </div>
